...
def launch_setup(context, params, param_name_suffix=''):
    ...
    return [
        ...
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory('megarover3_bringup'),'launch', 'UTM_30LX_tf.launch.py'))
        ),
        ...
        IncludeLaunchDescription(
            ...
            condition=LaunchConfigurationEquals('option', '_lrf_depthcam'),
        ),
